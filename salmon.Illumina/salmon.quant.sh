...
#SBATCH -n 12              	                                # number of cores (here uses 8)
#SBATCH --time=02:00:00    	                                # time allocation, which has the format (D-HH:MM), here set to 30 min
#SBATCH --mem=36G         	                                # memory pool for all cores (here set to 4 GB)
